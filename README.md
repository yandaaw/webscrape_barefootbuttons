# Web Scraping - Barefoot Buttons
<p align="center">
  <img width="400" height="200" src="https://i.ytimg.com/vi/6tb7zV2Kj4A/maxresdefault.jpg">
</p>
Barefoot Buttons is an e-commerce that sells Guitar pedal buttons easy on your feet, Barefoot Buttons make it easy to operate your pedals without shoes, and make them look great too. New design fits most true bypass stomp switches. 3 stainless steel set screws, comes with allen wrench. CNC machined from 6061 aircraft grade aluminum.
...
# About The Project
The main goal of this project is to gather data from the barefootbuttons.com site on item name, price, stock, sku, category, tags, description, and product weight, then extract it into a dataset and export it to excel and CSV file formats.
